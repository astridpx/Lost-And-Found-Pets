...
if (isset($_POST['submit'])) {
    ...
    if ($image_upload) {
        ...
        $sql = "INSERT INTO pets (name, img, category, breed, age, gender, location, reward, description, isMissing) VALUES (:name, :img, :category, :breed, :age, :gender, :location, :reward, :description, :isMissing)";
        ...
        $stmt->bindParam(':isMissing', $isMissing, PDO::PARAM_BOOL);
...
<div style="background-color: #ffff" class="container mt-3 mb-5 p-4 shadow-sm">
  <h2 class="mb-4">Lost Pet Form</h2>
